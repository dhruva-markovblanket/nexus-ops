...
export default function TeacherDashboard() {
  ...
  const navItems = [
    { id: 'overview', label: 'Overview', icon: PieChart, active: tab === 'overview' },
    { id: 'classes', label: 'Classes', icon: Users, active: tab === 'classes' },
    { id: 'assignments', label: 'Assignments', icon: ClipboardList, active: tab === 'assignments' },
    { id: 'exams', label: 'Exams', icon: BookOpen, active: tab === 'exams' },
    { id: 'announcements', label: 'Announcements', icon: Send, active: tab === 'announcements' },
  ]

  const renderContent = () => {
    switch (tab) {
      case 'overview': return <OverviewTab />
      case 'classes': return <PlaceholderTab name="Classes" description="Manage enrolled students in active courses." />
      case 'assignments': return <PlaceholderTab name="Assignments" description="Grade and view submitted course material." />
      case 'exams': return <PlaceholderTab name="Exams" description="Schedule online quizzes and testing sessions." />
      case 'announcements': return <PlaceholderTab name="Announcements" description="Broadcast messages to enrolled participants." />
